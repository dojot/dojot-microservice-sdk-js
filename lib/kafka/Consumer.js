  ...
  finish() {
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        ...
        this.commitManager.commitProcessedOffsets().then(() => {
          logger.debug('Error committing processed offsets');
        }).catch((err) => reject(err));

        return this.consumer.disconnect(async (err) => {
